...
1. **Le prêt** (offre de prêt) : montant emprunté, taux, date de la 1re échéance, **périodicité**
   ...
   **Déblocages après la 1re échéance de remboursement du capital** (plusieurs déblocages) : l'option
   ...
   - *totales* : échéance constante, calculée sur la totalité du prêt dès la 1re échéance, quelles que
     soient les dates des déblocages (cas du prêt n°141) ;
...
2. **Les déblocages** : import du grand livre du compte 164 exporté de Pennylane (recommandé : les
   ...
   tableau modifiable : double-clic pour corriger, case 🗑️ pour supprimer une ligne (elle disparaît aussitôt), ligne vide pour
...
- Le **solde** est toujours le capital réellement versé à chaque date : un déblocage postérieur augmente
  le solde à la date où il intervient. En échéances proratisées, les intérêts portent aussi sur les seuls
  fonds versés.
